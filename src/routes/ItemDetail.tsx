    ...
    <div className="grid gap-8 md:grid-cols-2">
      ...
      <div>
        ...
        <div className="mt-4 flex flex-wrap gap-2 text-sm text-forest-600">
          <span className="rounded-full bg-cream-200 px-3 py-1">{typeLabels[item.type] ?? item.type}</span>
        ...
        {!available ? (
          ...
          <p className="mt-6 rounded-lg bg-forest-50 p-3 text-forest-700">
          ...
          <div className="mt-6 flex flex-col gap-3">
            ...
            >
              {inCart ? 'Já está no carrinho' : addingToCart ? 'Adicionando...' : 'Comprar'}
            </button>
            {!showOfferForm ? (
              <button
